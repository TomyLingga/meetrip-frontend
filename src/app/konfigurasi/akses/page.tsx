...
export default function AdminConfigRolesPage() {
  ...
  return (
    <PageTemplate
      ...
      description="Daftarkan dan atur peran pengguna khusus untuk mengakses menu administrasi (Admin / SDM) MeeTrip."
    >
                  ...
                  <tr key={r.id} className="hover:bg-slate-50/20 dark:hover:bg-white/[0.01] transition-colors">
                    ...
                    <td className="py-4 px-5 text-sm text-right">
                      <button
                        ...
                        className="p-2 hover:bg-rose-500/10 rounded-xl text-slate-400 hover:text-rose-600 dark:hover:text-rose-450 transition-all cursor-pointer focus:outline-none"
